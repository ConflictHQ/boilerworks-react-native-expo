/**
 * PreviewScreen — component showcase / design-system playground (dev only).
 *
 * Renders every themed component with sample props so you can visually verify
 * the design system at a glance. Not linked from the main app navigation in
 * production builds — add it to AppStack temporarily when needed.
 *
 * Store: reads nothing.
 * Nav params: none.
 */
...
Paragraph with **bold** and *italic* text, plus \`inline code\`.
...
const CAROUSEL_ITEMS = [
  { id: '1', image: require('@/assets/images/logo-main.png'), title: 'Logo' },
  { id: '2', image: require('@/assets/images/icon.png'), title: 'Icon' },
  { id: '3', image: require('@/assets/images/splash-icon.png'), title: 'Splash' },
];

const PICKER_OPTIONS = ['Option A', 'Option B', 'Option C', 'Option D'];
...
const PreviewScreen = ({ route: _route }: Props) => {
  const theme = useThemeValues();
  const { control } = useForm<PreviewForm>({
    defaultValues: { email: '', password: '', notes: '' },
  });
  ...
  const [pickerValue, setPickerValue] = useState('Option A');
  ...
  return (
    <>
      <Container keyboardAvoiding>
        {/* ── Typography ── */}
        <SectionTitle>
          <Text family="PlayfairDisplay" size={20} weight="700">
            Typography
          </Text>
        </SectionTitle>

        <Text family="PlayfairDisplay" size={32}>
          PlayfairDisplay / 32
        </Text>
        <Text family="PlayfairDisplay" size={24}>
          PlayfairDisplay / 24
        </Text>
        <Text family="PlayfairDisplay" size={20}>
          PlayfairDisplay / 20
        </Text>
        <Text size={16}>Inter / 16 — body text</Text>
        <Text size={14} color={theme.colors.text.secondary}>
          Inter / 14 / secondary
        </Text>
        <Text size={12} color={theme.colors.text.secondary}>
          Inter / 12 / secondary
        </Text>
        ...
        <Row>
          <Chip variant="primary" onPress={() => {}}>
            Primary
          </Chip>
          <Chip variant="secondary" onPress={() => {}}>
            Secondary
          </Chip>
          <Chip variant="primary" disabled onPress={() => {}}>
            Disabled
          </Chip>
        </Row>
        <Row>
          <Chip variant="primary" selected onPress={() => {}}>
            Selected
          </Chip>
          <Chip variant="secondary" selected onPress={() => {}}>
            Selected
          </Chip>
        </Row>
        <Row>
          <Chip variant="primary" size="large" onPress={() => {}}>
            Large
          </Chip>
          <Chip variant="primary" size="medium" onPress={() => {}}>
            Medium
          </Chip>
        </Row>
        <Row>
          <Chip variant="primary" leftIcon="check" onPress={() => {}}>
            Left icon
          </Chip>
          <Chip variant="secondary" rightIcon="x-close" onPress={() => {}}>
            Right icon
          </Chip>
        </Row>
        ...
        <Row>
          <Avatar size="lg" variant="solid" initials="SO" />
          <Avatar size="lg" variant="gradient" initials="GR" />
          <Avatar size="lg" variant="outline" initials="OU" />
          <Avatar size="lg" iconName="user-01" />
        </Row>
        ...
        <Card variant="default" style={{ marginBottom: 8 }}>
          <Text size={16} weight="700">
            Default card
          </Text>
          <Text size={14} color={theme.colors.text.secondary}>
            With some body content inside.
          </Text>
        </Card>
        <Card variant="smallPadding" onPress={() => {}}>
          <Text size={14}>smallPadding + pressable</Text>
        </Card>
        ...
        <Checkbox
          checked={checked3}
          onToggle={() => setChecked3(v => !v)}
          label="Rounded unchecked"
          iconShape="rounded"
        />
        <Checkbox
          checked={checked4}
          onToggle={() => setChecked4(v => !v)}
          label="Rounded checked"
          iconShape="rounded"
        />
        <Checkbox
          checked={false}
        ...
        <Flex gap={8} direction="column">
          <MessageCard
            ...
            title="Primary"
            message="This is a primary message card."
          />
          <MessageCard
            colorVariant="secondary"
            title="Secondary"
            message="This is a secondary message card."
          />
          <MessageCard
            colorVariant="neutral"
            title="Neutral"
            message="This is a neutral message card."
            onClose={() => {}}
          />
          <MessageCard
            colorVariant="error"
        ...
        <Text size={12} color={theme.colors.text.secondary} style={{ marginBottom: 4 }}>
          Default — title + back button
        </Text>
        <Card variant="default" style={{ marginBottom: 8 }}>
          <ScreenHeader
            title="Screen title"
        ...
        <Row>
          {ALL_ICON_NAMES.map(name => (
            <IconCell key={name}>
              <Icons name={name} size={24} />
              <Text size={10} color={theme.colors.text.secondary} numberOfLines={1}>
                {name}
              </Text>
            </IconCell>
          ))}
        ...
        <View style={{ marginHorizontal: -16 }}>
          <Carousel items={CAROUSEL_ITEMS} height={200} autoPlayInterval={2500} />
        </View>
        ...
        <Picker
          ...
          onValueChange={v => setPickerValue(String(v))}
        >
        ...
        <PressableOpacity onPress={() => {}}>
          <Card variant="default">
            <Text size={16}>Press me — opacity animates on press</Text>
          </Card>
        </PressableOpacity>
      ...
      <BottomSheet ref={bottomSheetRef} title="BottomSheet demo" index={-1}>
        <Flex direction="column" gap={12} style={{ padding: 16 }}>
          <Text size={16}>This is a BottomSheet with some content inside.</Text>
          <Button
            variant="primary"
            size="medium"
            fullWidth
